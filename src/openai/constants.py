PROMPT_PET_FEATURES = (
    "Por favor, mira la imagen de la mascota que se encuentra adjunta y proporciona las siguientes "
    "características separadas por punto coma en una sola linea: species; breed; age(Dame un numero en meses); "
    "weight (en kilogramos, solo el numero); color; size (pequeño, mediano, grande). Como por ejemplo: "
    "species: Perro; breed: Mestizo; age: 60; weight: 25; color: Marrón claro y negro; size: Mediano. "
    "Si no existe ninguna mascota en la imagen devolver el siguiente mensaje: No existe ninguna mascota."
)
